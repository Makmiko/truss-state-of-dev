...
The fourth annual survey on Software Developers in Uzbekistan offers valuable insights into the community and their professional paths. We included a new section on AI to explore its impact on Moroccan software developers and how they are adjusting to this trend.
...
At our core, we value anonymity and as such, all collected data from the survey is anonymized. Raw results and the website code are also available under the BY-NC-SA 2.0 license on the [GeeksBlaBla GitHub organization](https://github.com/geeksblabla/stateofdev.uz).
