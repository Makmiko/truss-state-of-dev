...
AI is a hot topic in all the tech communities around the world. This year, we included a new section on AI to explore its impact on Uzbek software developers and how they are adjusting to this trend.

Uzbek software developers are embracing the AI age. They are learning AI and starting to build AI projects.
...
ChatGPT and GitHub Copilot are highly popular AI tools among Uzbek software developers. Over 90% of respondents use ChatGPT, while 35% use GitHub Copilot.
