...
The annual survey on Software Developers in Uzbekistan provides invaluable data on a community and their professional paths. Being the second year is even more interesting as we can draw trends from last year results. Following are a few selected takeaways:
...
- New data on location shows Uzbekistan is a coder nation, with half in the two biggest cities and another half in the rest of the Kingdom
...
We want to thank [all our amazing contributors and everyone](https://github.com/geeksblabla/stateofdev.uz#contributors-) who helped share the survey to get more submissions. We’re looking forward to your feedback and for you to share the results with your network.
