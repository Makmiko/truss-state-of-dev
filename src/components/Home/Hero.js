	...
	return (
		<>
			<div className="relative mb-14">
				...
				<div
					className="mx-auto h-full px-4 py-6 lg:py-12 sm:max-w-xl md:max-w-full md:px-24 md:py-36 lg:max-w-screen-2xl lg:px-8 relative">
					<div className="flex flex-col items-center justify-between lg:flex-row ">
						<div className="my-16">
							<div className="lg:max-w-xl lg:pr-5 ">
								<h2
									className="mb-6 max-w-lg text-4xl text-center font-light leading-snug tracking-tight text-purple-600 sm:text-6xl sm:text-left ">
									State Of Dev In{' '}
                    ...
                    {' '}
								...
								<p
									className=" lg: mt-1 text-sm text-center tracking-normal text-gray-800 lg:mt-1 lg:text-xl lg:text-left">
							...
							<div className="mt-10 flex flex-col items-center md:items-stretch md:flex-row ">
								<Link to="/beforeStart">
									<div
										...
										<div
											className="absolute left-0 -bottom-10 inline-flex h-10 w-10 -rotate-12 -scale-x-100 text-purple-700">
											<svg
												viewBox="0 0 82 35"
												fill="none"
								...
								<div className="flex max-w-xs space-x-2 justify-center items-center text-sm ml-8 mt-8 md:mt-0 md:ml-0">
									<TimeIcon className="h-7"/>
									<p> The survey should take you about 10 minutes</p>
								</div>
								{/*<Link*/}
								{/*  to="/2022"*/}
								{/*  aria-label=""*/}
...
export const YoutubeVideo = () => {
	...
	return (
		<>
			<div className="relative shadow-xl shadow-purple-200/50  lg:w-1/2 align-[default]">
				<img
					className="hidden h-56 w-full rounded-lg object-cover shadow-lg sm:h-96 lg:block"
					src="/images/video-cover-v2.png?v=3.0"
					alt=""
				/>
				<video className="h-56 w-full rounded-lg object-cover shadow-lg sm:h-96 lg:hidden" controls
				       poster="/images/video-cover-v2.png?v=3.0">
					<source src="/video/intro.mp4" type="video/mp4"/>
				</video>
				<button
					onClick={() => setOpen(true)}
					aria-label="Play Video"
					className="hidden group absolute inset-0 h-full w-full items-center justify-center bg-gray-900 bg-opacity-30 transition-colors duration-300 hover:bg-opacity-10 lg:flex"
				>
					<div
						className="flex h-16 w-16 transform items-center justify-center rounded-full bg-gray-100/80 shadow-2xl transition duration-300 group-hover:scale-110">
						<svg
				...
				>
					...
					<div className="fixed inset-0 z-[100] w-screen overflow-y-auto">
						<div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0 ">
							...
							>
								<Dialog.Panel
									className="relative transform h-full w-full rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full lg:w-[80vw] justify-center items-center  max-w-[1200px]">
