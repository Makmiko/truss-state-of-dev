...
const useData = (year = 2022) => {
  const {
    ...
    `https://raw.githubusercontent.com/geeksblabla/state-of-dev-uz.com/master/results/${year}/data/questions.json`
  )
  ...
  const {
    ...
    `https://raw.githubusercontent.com/geeksblabla/state-of-dev-uz.com/master/results/${year}/data/results.json`
  )
